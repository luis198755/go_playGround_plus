...
export function TerminalOutput({ output, isLoading, onClear, isMarkdown = false }: TerminalOutputProps) {
  ...
  return (
    <div className="flex flex-col h-[500px] lg:h-[700px] min-h-0">
      ...
      <div className="flex-1 bg-[#0C0C0C] rounded-lg overflow-hidden border border-[#333] flex flex-col min-h-0 max-h-full">
        ...
        <div 
          ref={terminalRef}
          className={`flex-1 font-mono text-sm overflow-y-auto p-4 bg-[#0C0C0C] h-full ${isMarkdown ? 'markdown-preview' : ''}`}
          style={{ 
