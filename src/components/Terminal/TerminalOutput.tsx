...
export function TerminalOutput({ output, isLoading, onClear, isMarkdown = false }: TerminalOutputProps) {
  ...
  return (
    <div className="flex flex-col h-full md:h-full" style={{ minHeight: `${contentHeight}px` }}>
      ...
      <div className="flex-1 bg-[#0C0C0C] rounded-lg overflow-hidden border border-[#333] flex flex-col min-h-0">
        ...
        <div 
          ref={terminalRef}
          className={`flex-1 font-mono text-sm overflow-y-auto p-4 min-h-0 bg-[#0C0C0C] ${isMarkdown ? 'markdown-preview' : ''}`}
          style={{ 
